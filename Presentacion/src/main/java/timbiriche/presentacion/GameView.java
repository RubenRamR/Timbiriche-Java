...
public class GameView extends JFrame {
    ...
    /**
     * Método público para permitir que el Modelo (vía Observer) actualice la vista
     * cuando llegue confirmación del servidor.
     * (Por ahora mantiene su propia caché visual 'optimista' en el panel).
     */
